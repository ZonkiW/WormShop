...
<script type="text/javascript">
	function addCart(){
		...
		location.href="${pageContext.request.contextPath}/product?method=sendToCart&pid=${productInfo.pid}&buyNum="+buyNum;
	}
		...
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div>
						<a href='${pageContext.request.contextPath}/product?method=PageProduct&cid=${cid}&targetPage=${currentPage}'>返回商品列表</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
